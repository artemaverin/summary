...
![image](https://github.com/artemaverin/summary/assets/97846877/71c88a1b-f424-45dd-ab70-6eaf01eca497)
...
![image](https://github.com/artemaverin/summary/assets/97846877/3c0b118a-f378-4d3d-98a4-89fbe6342f13)
...
![image](https://github.com/artemaverin/summary/assets/97846877/ce9f9662-0a53-44cb-9de4-53632abc8d0a)
...
![image](https://github.com/artemaverin/summary/assets/97846877/63441813-d31e-4d8c-a86a-bca72ebfb50c)
...
![image](https://github.com/artemaverin/summary/assets/97846877/a90841ad-191c-4384-bfa8-177d51a216f0)
...
Инструменты мониторинга памяти и процессов сборки мусора целесообразно разделить на две группы:
 - внутренние, являющиеся частью той программы, которую мы мониторим, встроенные в JDK утилиты: jps, jmap, jstat, jconsole, visualvm до java 9.
 - внешние, подключаемые к процессу исследуемой программы извне. внешние: VisualVM c java 9 и утилита от NetBeans - YourKit Java Profiler.
...
Разница между типами ссылок заключается в том, что объекты в куче, на которые они ссылаются, имеют право на сборку мусора по различным критериям. Рассмотрим подробнее каждую из них.
...
https://habr.com/ru/companies/otus/articles/468193/
 ...
 Основная задача JVM — загружать class-файлы и выполнять содержащийся в них байт-код.
...
Загрузка классов — это поиск и загрузка типов (классов и интерфейсов) динамически во время выполнения программы. Данные о типах находятся в бинарных class-файлах.Она также выполняет проверку правильности импортируемых классов, выделяет и инициализирует память для переменных класса, помогает в разрешении символьных ссылок.
