...
https://habr.com/ru/articles/500468/
...
*Всё программирование сводится к хранению, передаче и изменению данных. Для этих операций в программировании есть понятие переменная.\
...
*Переменная - это поименованная область памяти, в которую мы можем сохранить данные, осуществлять доступ к этим данным или изменять их.\
