...
[25. Пример какова сложность поиска значения по ключу?](#25-Пример-какова-сложность-поиска-значения-по-ключу)
...
+ [В чем разница между Iterator и Iterable?](#В-чем-разница-между-Iterator-и-Iterable)
...
## 11. Расскажите реализации интерфейса Set? V
...
## 13. Отличие ArrayList от LinkedList? V
...
## 15. Расскажите про методы Object hashCode и equals? V
...
## 16. Расскажите, что такое коллизии в Map Как с ними бороться? V
...
## 29. Правила проверки при переопределении метода equals? V (про свойства)
...
## 31. Какое начальное количество корзин в HashMap? V
...
## 34. Как и когда происходит увеличение количества корзин в HashMap? V
...
Iterator< E > iterator() – метод возвращает объект Iterator (объекта Iterable), который позволяет проходить по элементам нашей коллекции.
...
## Назовите преимущества использования коллекций. V
...
## Какие данные могут хранить коллекции? V
...
## Как задается порядок следования объектов в коллекции, как отсортировать коллекцию? V
...
## Чем отличается Comparable от Comparator? V
...
## Какие есть способы перебора всех элементов List? V
...
## Что будет если вызвать метод put несколько раз с одинаковым ключом? V
...
## В чем разница между Iterator и Iterable? V
...
## В чем отличие метода poll() от remove()? V
...
## Что такой односторонние и двусторонние очереди? V
