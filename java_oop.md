...
Классы StringBuilder и StringJoiner не синхронизированы. Они будут некорректно работать в многопоточной среде. **StringBuffer** - это аналог StringBuilder, только с синхронизированными методами для работы в многопоточном окружении. Многопоточность мы будет проходить в курсе Middle, поэтому дальнейший разбор данного класса выходит за рамки этого урока.
