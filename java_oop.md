...
[28. Может ли интерфейс содержать какие-либо методы с реализацией? Если да, то какие?](#28-Может-ли-интерфейс-содержать-какие-либо-методы-с-реализацией)
...
Ни одного. экземпляр/объекту абстрактного класса создать нельзя
