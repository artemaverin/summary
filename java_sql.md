...
Конструкцию try-with-resources ввели в Java 7. Она дает возможность объявлять один или несколько ресурсов в блоке try, которые будут закрыты автоматически без использования finally блока. В качестве ресурса можно использовать любой объект, класс которого реализует интерфейс java.lang.AutoCloseable или Java.io.Closable.

В частности, это относится к подключениям к базам данных, потокам ввода-вывода и другим ресурсам, требующим отдельного закрытия.

Это позволяет избежать распространенной ошибки, когда программист забывает закрыть ресурс, что может привести к утечке ресурсов или другим нежелательным последствиям.
