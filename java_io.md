...
Serializable используется для сериализации объекта в поток байтов и его десериализации обратно в объект при чтении из потока. Serializable позволяет сохранять объект в файл или передавать его по сети.

Externalizable используется для сохранения объекта в файл и его извлечения из файла. Externalizable не может использоваться для передачи объекта по сети или использовать его в других программах.
