...
- **np.maximum** - возвращает наибольшие значения поэлементного сравнения значений массивов.
- **np.minimum** - возвращает наименьшее значения поэлементного сравнения значений массивов.
